                ...
                <div class="col-md-12">
                    <div class="card card-success">
                        <div class="card-header">
                            <h3 class="card-title">Sửa danh mục: {{ $banner->name }}</h3>
                        </div>

                        <form action="{{ route('admin.banners.home-banner.update', $banner->id) }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            <div class="card-body">
